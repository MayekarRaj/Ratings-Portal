...
export default function upload() {
    ...
    return (
        <div className='flex w-screen h-screen'>
            <Head>
                <title>Admin | Upload Teacher Doc</title>
            </Head>
                ...
                <div className='m-8'>
                    ...
                    {!fileuploaded &&
                        <div className='h-full w-full flex justify-center content-center '>
                            <div className='translate-y-32 h-72 w-96 bg-secondary p-8 space-y-12 align-middle'>
                                <h1 className='text-2xl font-semibold justify-center flex m-8'>Upload Teacher Doc</h1>
                    ...
                    {fileuploaded &&
                        <div className="bg-secondary px-4">
                            <div className="pt-4">
                                {filedata && <TeacherDetails isUpload={true} teachersData={filedata} />}
                            </div>

                            <div className="flex justify-end">
                                <button onClick={sendFileData} className="bg-button text-white m-8 rounded p-4">Submit to Database</button>
